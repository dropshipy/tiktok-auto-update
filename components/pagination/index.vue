...
<template>
  <div class="flex space-x-2 items-center text-[#A0A3BD66]/40">
    <button
      ...
      :class="
        pagination.currentPage !== 1 ? 'bg-primary/10' : 'bg-[#A0A3BD80]/10'
      "
    ...
    >
      <Icon
        ...
        :size="16"
        :class="
          pagination.currentPage !== 1 ? 'text-primary' : 'text-[#A0A3BD80]/50'
        "
      />
    </button>
    <ul class="flex space-x-2 items-center" v-if="pagination">
      <li
      ...
      <li
        ...
        :key="pageNumber"
        :class="{
          'font-bold text-primary bg-none':
