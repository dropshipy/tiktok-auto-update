...
<template>
  <Transition name="snackbar">
    <div
      v-if="isVisible"
      :class="`snackbar--${type}`"
      class="flex items-center fixed right-[30px] top-[100px] p-3 bg-white shadow-md z-[100] rounded-md border-l-4"
    >
      <div
        class="flex items-center justify-center w-10 h-10 p-2 mr-3 rounded-full"
      ...
      <button
        class="flex items-center justify-center w-7 h-7 bg-gray-100 rounded-full ml-4"
        @click="hide"
      >
